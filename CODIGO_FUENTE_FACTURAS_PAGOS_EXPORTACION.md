...
2. [Librería de Cálculo de Totales](#2-librería-de-cálculo-de-totales)
3. [Edge Function: validate-invoice-xml](#3-edge-function-validate-invoice-xml)
4. [Edge Function: extract-payment-proof-info](#4-edge-function-extract-payment-proof-info)
5. [Componente: PaymentProofsHistory](#5-componente-paymentproofshistory)
6. [Componente: InvoicePaymentProofUpload](#6-componente-invoicepaymentproofupload)
7. [Página: Payments.tsx](#7-página-paymentstsx)
...
## 2. LIBRERÍA DE CÁLCULO DE TOTALES
...
## 3. EDGE FUNCTION: validate-invoice-xml
...
## 4. EDGE FUNCTION: extract-payment-proof-info
...
## 5. COMPONENTE: PaymentProofsHistory
...
## 6. COMPONENTE: InvoicePaymentProofUpload
...
## 7. PÁGINA: Payments.tsx (Fragmentos clave)
