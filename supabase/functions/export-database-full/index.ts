...
-- ============================================================================\n`;
      ...
      for (const table of tables) {
        ...
        // Guardar nombres de columnas para usar después en INSERT
        tableColumns[table.table_name] = columns.map(c => c.column_name);
...
-- ============================================================================\n`;
    ...
    const foreignKeysResult = await client.queryObject<{
